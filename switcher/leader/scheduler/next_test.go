...
import (
	...
	scheduler2 "github.com/clambin/ledswitcher/switcher/leader/scheduler"
...
func TestScheduler_Next(t *testing.T) {
	...
	s.Register("host1")
	assert.Equal(t, []scheduler2.Action{{Host: "host1", State: true}}, s.Next())
...
func hostDown(s *scheduler2.Scheduler, hosts ...string) {
